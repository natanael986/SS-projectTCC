        ...
        <div class="container" id="container">
            <div class="form-container sign-in-container">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <x-text-input id="email" type="text" placeholder="email" name="email" :value="old('email')" required
                        autofocus />
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <x-text-input id="password" type="password" placeholder="Senha" name="password" required
            ...
            <div class="form-container sign-up-container">
                <form id="myForm" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <input type="int" id="ano_nascimento" name="ano_nascimento" placeholder="Ano de Nascimento Ex:2000"
                        maxlength="4" />
                    ...
                    <input id="confirm-password" placeholder="Insira a Senha novamente" type="password"
