...
<div class="form-style-5">
    <form method="POST" action="{{ route('postmanager.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <fieldset>
            ...
            <input type="text" name="tittle" placeholder="GOAT">

            <label>Escreva sua definição</label>
            <textarea type="text" maxlength="500" name="publication" placeholder="GOAT é um termo..."></textarea>

            <label>Contexto que a palavra ou expressão se encaixa</label>
            <textarea name="context" maxlength="500" placeholder="Lionel Messi é o GOAT"></textarea>
